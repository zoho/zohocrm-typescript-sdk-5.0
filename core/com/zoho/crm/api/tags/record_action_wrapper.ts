...
class RecordActionWrapper implements Model, RecordActionHandler{
	 ...
	 * @returns A Boolean representing the lockedCount
	 */
	public getLockedCount(): boolean	{
	 ...
	 * @param lockedCount A Boolean representing the lockedCount
	 */
	public setLockedCount(lockedCount: boolean): void	{
