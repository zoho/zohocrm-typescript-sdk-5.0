import {AssociatedUsersCount} from "./associated_users_count";
...
class AssociatedUsersCountWrapper implements Model, ResponseHandler{
	...
	private associatedUsersCount: Array<AssociatedUsersCount>;
	private info: Info;
	 ...
	 */
	public getAssociatedUsersCount(): Array<AssociatedUsersCount>	{
	 ...
	 */
	public setAssociatedUsersCount(associatedUsersCount: Array<AssociatedUsersCount>): void	{
...
export {
	AssociatedUsersCountWrapper as MasterModel,
	AssociatedUsersCountWrapper as AssociatedUsersCountWrapper
}
