...
class CreateShiftHours
{
    static async createShiftHours()
    {
        ...
        shiftHour.setTimezone(moment.tz.zone("Asia/Kolkata"));
        ...
        holiday.setDate(new Date(2023, 12, 12));
        // holiday.setId(4043241233231233);
        ...
        let response : ZOHOCRMSDK.APIResponse<ZOHOCRMSDK.HoursShift.ActionHandler.MasterModel>= await shiftHoursOerations.createShiftsHours(request);
        if (response != null)
        {
...
CreateShiftHours.initializeAndCall();
