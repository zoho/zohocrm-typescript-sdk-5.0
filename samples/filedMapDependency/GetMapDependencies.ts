...
{
    static async getMapDependencies(layoutId: bigint, module: string)
    {
        ...
        let response : ZOHOCRMSDK.APIResponse<ZOHOCRMSDK.DependencyFieldMap.ResponseHandler.MasterModel>= await fieldMapDependencyOperations.getMapDependencies(paramInstance);
        if (response != null)
        {
    ...
    static async initializeAndCall()
    {
        ...
        await (await new ZOHOCRMSDK.InitializeBuilder())
            ...
            .token(token)
            .initialize();
        await GetMapDependencies.getMapDependencies(BigInt("440280167"), "Leads");
    }
}
GetMapDependencies.initializeAndCall();
