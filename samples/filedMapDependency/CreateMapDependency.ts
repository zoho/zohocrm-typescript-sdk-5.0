...
export class CreateMapDependency
{
    static async createMapDependency(layoutId: bigint, module: string)
    {
        ...
        pickListMap.setId(BigInt("440280011274"));
        ...
        pickListMap.setId(BigInt("440280011268"));
        ...
        let response : ZOHOCRMSDK.APIResponse<ZOHOCRMSDK.DependencyFieldMap.ActionHandler.MasterModel>= await fieldMapDependencyOperations.createMapDependency(bodyWrapper);
        if (response != null) {
    ...
    static async initializeAndCall()
    {
        ...
        await (await new ZOHOCRMSDK.InitializeBuilder())
            ...
            .token(token)
            .initialize();
        await CreateMapDependency.createMapDependency(BigInt("440280167"), "Leads");
    }
}
CreateMapDependency.initializeAndCall();