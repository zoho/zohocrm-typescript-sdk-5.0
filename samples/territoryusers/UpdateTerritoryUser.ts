...
{
    static async updateTerritoryUser(user: bigint, territory: bigint)
    {
        ...
        let response : ZOHOCRMSDK.APIResponse<ZOHOCRMSDK.TerritoryUsers.ActionHandler.MasterModel> = await territoryUsersOperations.updateTerritoryUser(user, territory);
        if (response != null) {
    ...
    static async initializeAndCall()
    {
        ...
        await (await new ZOHOCRMSDK.InitializeBuilder())
            ...
            .token(token)
            .initialize();
        await UpdateTerritoryUser.updateTerritoryUser(BigInt("44028001502002"), BigInt("44028001305227"));
    }
}
UpdateTerritoryUser.initializeAndCall();