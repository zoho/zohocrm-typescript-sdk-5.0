...
class CreateUsersUnavailability
{
    static async createUsersUnavailability()
    {
        ...
        let response : ZOHOCRMSDK.APIResponse<ZOHOCRMSDK.UnavailabilityUsers.ActionHandler.MasterModel>= await usersOperations.createUsersUnavailability(request);
        if(response != null)
        {
...
CreateUsersUnavailability.initializeAndCall();
