...
{
    static async createInvoices(moduleAPIName: string)
    {
        ...
        contactName.setId(BigInt("44028001659005"));
        ...
        dealName.setId(BigInt("44028001538050"));
        record1.addKeyValue("Deal_Name__s", dealName);
        let salesOrder : ZOHOCRMSDK.Record.Record = new ZOHOCRMSDK.Record.Record();
        salesOrder.setId(BigInt("44028001390098"));
    ...
    static async initializeAndCall() {
        ...
        await (await new ZOHOCRMSDK.InitializeBuilder())
            ...
            .token(token)
            .initialize();
        await CreateInvoices.createInvoices("Invoices");
    }
}
CreateInvoices.initializeAndCall();
