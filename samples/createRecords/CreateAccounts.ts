...
{
    static async createAccounts(moduleAPIName: string)
    {
        ...
        record1.addKeyValue("Email", 'abc323123@gmail.com');
        ...
        await record1.addFieldValue(ZOHOCRMSDK.Record.Field.Accounts.ACCOUNT_NUMBER, BigInt("101"));
        ...
        parent_account.setId(BigInt("44028001393052"));
        ...
        fileDetail.setFileIdS("ae9c7cefa4a5cc2d9ab35c32a6ae23d729ad87c6d90b0bd44183");
        fileDetails.push(fileDetail);
        let fileDetail2 : ZOHOCRMSDK.Record.FileDetails = new ZOHOCRMSDK.Record.FileDetails();
        fileDetail2.setFileIdS("ae9c7cefa418adbhd9ab35c32a6ae2329ad87c6d90b0bd44183");
    ...
    static async initializeAndCall()
    {
        ...
        await (await new ZOHOCRMSDK.InitializeBuilder())
            ...
            .token(token)
            .initialize();
        await CreateAccounts.createAccounts("Accounts");
    }
}
CreateAccounts.initializeAndCall();
