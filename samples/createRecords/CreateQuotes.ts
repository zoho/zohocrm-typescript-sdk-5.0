...
class CreateQuotes
{
    static async createQuotes(moduleAPIName: string)
    {
        ...
        await accountName.addFieldValue(ZOHOCRMSDK.Record.Field.Accounts.ID, BigInt("44028001659002"));
        ...
        await dealName.addFieldValue(ZOHOCRMSDK.Record.Field.Deals.ID, BigInt('44028001538050'));
        ...
        await contactName.addFieldValue(ZOHOCRMSDK.Record.Field.Contacts.ID, BigInt("44028001659005"));
    ...
    static async initializeAndCall() {
        ...
        await (await new ZOHOCRMSDK.InitializeBuilder())
            ...
            .token(token)
            .initialize();
        await CreateQuotes.createQuotes("Quotes");
    }
}
CreateQuotes.initializeAndCall();
