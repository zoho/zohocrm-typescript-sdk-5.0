...
{
    static async createContacts(moduleAPIName: string)
    {
        ...
        await record1.addFieldValue(ZOHOCRMSDK.Record.Field.Contacts.EMAIL, 'abc233e3@gmail.com');
        ...
        await record1.addFieldValue(ZOHOCRMSDK.Record.Field.Contacts.HOME_PHONE, '3022222');
        ...
        accountName.setId(BigInt("44028001659002"));
        ...
        vendorName.setId(BigInt("44028001392120"));
        await record1.addFieldValue(ZOHOCRMSDK.Record.Field.Contacts.VENDOR_NAME, vendorName);
        let reportingTo : ZOHOCRMSDK.Record.Record = new ZOHOCRMSDK.Record.Record();
        reportingTo.setId(BigInt("44028001659005"));
    ...
    static async initializeAndCall() {
        ...
        await (await new ZOHOCRMSDK.InitializeBuilder())
            ...
            .token(token)
            .initialize();
        await CreateContacts.createContacts("Contacts");
    }
}
CreateContacts.initializeAndCall();
