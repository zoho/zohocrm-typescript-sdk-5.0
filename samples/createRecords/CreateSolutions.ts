...
{
    static async createSolutions(moduleAPIName: string)
    {
        ...
        productName.setId(BigInt("44028001391082"));
        await productName.addFieldValue(ZOHOCRMSDK.Record.Field.Solutions.PRODUCT_NAME, productName);
        let solutionOwner :  ZOHOCRMSDK.Users.MinifiedUser = new ZOHOCRMSDK.Users.MinifiedUser();
        solutionOwner.setId(BigInt("440280254001"));
        await record1.addKeyValue("Owner", solutionOwner);
    ...
    static async initializeAndCall() {
        ...
        await (await new ZOHOCRMSDK.InitializeBuilder())
            ...
            .token(token)
            .initialize();
        await CreateSolutions.createSolutions("Solutions");
    }
}
CreateSolutions.initializeAndCall();
