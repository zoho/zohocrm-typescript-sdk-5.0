...
{
    static async createSalesOrders(moduleAPIName: string)
    {
        ...
        let account : ZOHOCRMSDK.Record.Record = new ZOHOCRMSDK.Record.Record();
//		account.addKeyValue("name", "automated");
        await account.addFieldValue(ZOHOCRMSDK.Record.Field.Accounts.ID, BigInt("44028001659002"));
        ...
        let quoteName : ZOHOCRMSDK.Record.Record = new ZOHOCRMSDK.Record.Record();
        await quoteName.addFieldValue(ZOHOCRMSDK.Record.Field.Quotes.ID, BigInt('44028001661088'));
        ...
        let deal_name : ZOHOCRMSDK.Record.Record = new ZOHOCRMSDK.Record.Record();
        await deal_name.addFieldValue(ZOHOCRMSDK.Record.Field.Deals.ID, BigInt("44028001538050"));
        await record1.addFieldValue(ZOHOCRMSDK.Record.Field.Sales_Orders.DEAL_NAME, deal_name);
        let contact_name : ZOHOCRMSDK.Record.Record = new ZOHOCRMSDK.Record.Record();
        await contact_name.addFieldValue(ZOHOCRMSDK.Record.Field.Contacts.ID, BigInt("44028001659005"));
        ...
        lineItemProduct.setId(BigInt("440280954344"));
        ...
        productLineTax.setId(BigInt("440280020810"));
...
CreateSalesOrder.initializeAndCall();
