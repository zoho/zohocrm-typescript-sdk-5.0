...
class UpdateSolutions
{
    static async updateSolutions(moduleAPIName : string)
    {
        ...
        await record1.addFieldValue(ZOHOCRMSDK.Record.Field.Solutions.SOLUTION_TITLE, "new Solution");
        await record1.addFieldValue(ZOHOCRMSDK.Record.Field.Solutions.QUESTION, "question?");
        await record1.addFieldValue(ZOHOCRMSDK.Record.Field.Solutions.ANSWER, "answer.");
        await record1.addFieldValue(ZOHOCRMSDK.Record.Field.Solutions.STATUS, new ZOHOCRMSDK.Choice('Draft'));
        let productName : ZOHOCRMSDK.Record.Record = new ZOHOCRMSDK.Record.Record();
        productName.setId(BigInt("4402801391082"));
        await productName.addFieldValue(ZOHOCRMSDK.Record.Field.Solutions.PRODUCT_NAME, productName);
        let solutionOwner : ZOHOCRMSDK.Users.Users = new ZOHOCRMSDK.Users.Users();
        solutionOwner.setId(BigInt("440280254001"));
        await record1.addFieldValue(ZOHOCRMSDK.Record.Field.Solutions.OWNER, solutionOwner);
    ...
    static async initializeAndCall() {
        ...
        await (await new ZOHOCRMSDK.InitializeBuilder())
            ...
            .token(token)
            .initialize();
        await UpdateSolutions.updateSolutions("Solutions");
    }
}
UpdateSolutions.initializeAndCall();
