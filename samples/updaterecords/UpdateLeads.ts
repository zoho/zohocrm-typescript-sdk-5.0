...
class UpdateLeads
{
    static async updateLeads(moduleAPIName: string)
    {
        ...
        record1.setId(BigInt('44028001821046'));
        ...
        deleteFrom.setId(BigInt("44028001821053"));
    ...
    static async initializeAndCall() {
        ...
        await (await new ZOHOCRMSDK.InitializeBuilder())
            ...
            .token(token)
            .initialize();
        await UpdateLeads.updateLeads("Leads");
    }
}
UpdateLeads.initializeAndCall();
