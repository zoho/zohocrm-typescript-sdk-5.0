...
class UpdatePurchaseOrders
{
    static async updatePurchaseOrders(moduleAPIName: string)
    {
        ...
        await vendor.addFieldValue(ZOHOCRMSDK.Record.Field.Vendors.ID, BigInt("440280330038"));
    ...
    static async initializeAndCall() {
        ...
        await (await new ZOHOCRMSDK.InitializeBuilder())
            ...
            .token(token)
            .initialize();
        await UpdatePurchaseOrders.updatePurchaseOrders("Purchase_Orders");
    }
}
UpdatePurchaseOrders.initializeAndCall();
