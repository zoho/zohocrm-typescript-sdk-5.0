...
class UpdateDeals
{
    static async updateDeals(moduleAPIName: string)
    {
        ...
        accountName.setId(BigInt("44028090054"));
        ...
        contactName.setId(BigInt("440280393062"));
        ...
        campaign_source.setId(BigInt("4402801393057"));
    ...
    static async initializeAndCall() {
        ...
        await (await new ZOHOCRMSDK.InitializeBuilder())
            ...
            .token(token)
            .initialize();
        await UpdateDeals.updateDeals("Deals");
    }
}
UpdateDeals.initializeAndCall();
