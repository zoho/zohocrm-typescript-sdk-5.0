...
class GetUserTypes
{
    static async getUserTypes(portalName: any)
    {
        ...
        let response : ZOHOCRMSDK.APIResponse<ZOHOCRMSDK.PortalTypeUser.ResponseHandler.MasterModel>= await userTypeOperations.getUserTypes(paramInstance);
        if (response != null) {
    ...
    static async initializeAndCall()
    {
        ...
        await (await new ZOHOCRMSDK.InitializeBuilder())
            ...
            .token(token)
            .initialize();
        await GetUserTypes.getUserTypes("PortalAPITest1");}
}
GetUserTypes.initializeAndCall();