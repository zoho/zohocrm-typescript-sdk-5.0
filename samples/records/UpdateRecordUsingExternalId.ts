...
class UpdateRecordUsingExternalId{
     ...
     */
    static async updateRecordUsingExternalId(moduleAPIName: string, externalFieldValue: string) {
        ...
        let response : ZOHOCRMSDK.APIResponse<ZOHOCRMSDK.Record.ActionHandler.MasterModel>= await recordOperations.updateRecordUsingExternalId(externalFieldValue, moduleAPIName, request, headerInstance);
        if (response != null) {
    ...
    static async initializeAndCall()
    {
        ...
        await (await new ZOHOCRMSDK.InitializeBuilder())
            ...
            .token(token)
            .initialize();
        await UpdateRecordUsingExternalId.updateRecordUsingExternalId("Leads", "3234242343");
    }
}
