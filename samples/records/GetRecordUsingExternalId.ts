...
class GetRecordUsingExternalId {
     ...
     */
    static async getRecordUsingExternalId(moduleAPIName: string, externalFieldValue: string, destinationFolder: string) {
        //example
        ...
        */
        ...
        await headerInstance.add(ZOHOCRMSDK.Record.GetRecordHeader.X_EXTERNAL, "Leads.external123");
    ...
    static async initializeAndCall()
    {
        ...
        await (await new ZOHOCRMSDK.InitializeBuilder())
            ...
            .token(token)
            .initialize();
        await GetRecordUsingExternalId.getRecordUsingExternalId("Leads", "12345", "users/docs/file");
    }
}
GetRecordUsingExternalId.initializeAndCall();
