...
{
    static async updateScoringRule(id:bigint)
    {
        ...
        scoringRule.setName("Rule 11 Updated");
        ...
        module.setId(BigInt("440280371049"));
        ...
        layout.setId(BigInt("440280167n"));
        ...
        signal.setId(BigInt("4876876112019n"));
        ...
        let response : ZOHOCRMSDK.APIResponse<ZOHOCRMSDK.RulesScoring.ActionHandler.MasterModel> = await scoringRulesOperations.updateScoringRule(id, bodyWrapper);
        if (response != null)
        {
    ...
    static async initializeAndCall()
    {
        ...
        await (await new ZOHOCRMSDK.InitializeBuilder())
            ...
            .token(token)
            .initialize();
        await UpdateScoringRule.updateScoringRule(BigInt("44028001626031n"));
    }
}
UpdateScoringRule.initializeAndCall();
