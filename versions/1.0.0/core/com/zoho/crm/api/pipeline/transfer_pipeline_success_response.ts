...
class TransferPipelineSuccessResponse implements Model, TransferPipelineActionResponse{
...
export {
	TransferPipelineSuccessResponse as MasterModel,
	TransferPipelineSuccessResponse as TransferPipelineSuccessResponse
}
