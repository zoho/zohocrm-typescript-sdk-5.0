import {PortalInvite} from "./portal_invite";
import {Model} from "../../../../../../utils/util/model";

class BodyWrapper implements Model{

	private portalInvite: Array<PortalInvite>;
	private keyModified: Map<string, number> = new Map<string, number>();
	/**
	 * The method to get the portalInvite
	 * @returns An Array representing the portalInvite
	 */
	public getPortalInvite(): Array<PortalInvite>	{
	 ...
	 */
	public setPortalInvite(portalInvite: Array<PortalInvite>): void	{
