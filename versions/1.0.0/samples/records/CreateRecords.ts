...
class CreateRecords{
    ...
    static async createRecords(moduleAPIName: string) {
        ...
        let tax :  ZOHOCRMSDK.Record.Tax = new ZOHOCRMSDK.Record.Tax();
        ...
        await accountName.addFieldValue(ZOHOCRMSDK.Record.Field.Accounts.ID, BigInt("4402800884001"));
        ...
        lineItemProduct.setId(BigInt("4402800954344"));
        ...
        whoId.setId(BigInt("347706112263005"));
        ...
        whatId.setId(BigInt("347706112263002"));
        ...
        await record.addFieldValue(ZOHOCRMSDK.Record.Field.Events.REMIND_AT, reminderList);
        ...
        whatId1.setId(BigInt('347706112419002'));
        ...
        await record.addFieldValue(ZOHOCRMSDK.Record.Field.Price_Books.PRICING_MODEL, new ZOHOCRMSDK.Choice("Flat"));
        /** End of Price_Books */
        let tagsArray = [];
