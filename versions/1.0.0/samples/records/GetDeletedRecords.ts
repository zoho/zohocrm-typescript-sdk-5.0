...
class GetDeletedRecords {
     ...
     */
    static async getDeletedRecords(moduleAPIName:string) {
        //example
        ...
        let response : ZOHOCRMSDK.APIResponse<ZOHOCRMSDK.Record.DeletedRecordsHandler.MasterModel>= await recordOperations.getDeletedRecords(moduleAPIName, paramInstance, headerInstance);
        if (response != null) {
            ...
            if (responseObject != null) {
                if (responseObject instanceof ZOHOCRMSDK.Record.DeletedRecordsWrapper) {
                    let deletedRecords :  ZOHOCRMSDK.Record.DeletedRecord[] = responseObject.getData();
    ...
    static async initializeAndCall()
    {
        ...
        await (await new ZOHOCRMSDK.InitializeBuilder())
            ...
            .token(token)
            .initialize();
        await GetDeletedRecords.getDeletedRecords("Leads");
    }
}
