...
class UpdateCalls
{
    static async updateCalls(moduleAPIName:string)
    {
        ...
        whoId.setId(BigInt("44028001030088"));
        await record1.addFieldValue(ZOHOCRMSDK.Record.Field.Calls.WHO_ID, whoId);
        let whatId : ZOHOCRMSDK.Record.Record = new ZOHOCRMSDK.Record.Record();
        whatId.setId(BigInt("4402801389082"));
        await record1.addFieldValue(ZOHOCRMSDK.Record.Field.Calls.WHAT_ID, whatId);
        await record1.addFieldValue(ZOHOCRMSDK.Record.Field.Calls.CALL_TYPE, new ZOHOCRMSDK.Choice("Outbound"));
        await record1.addFieldValue(ZOHOCRMSDK.Record.Field.Calls.OUTGOING_CALL_STATUS, new ZOHOCRMSDK.Choice("Scheduled"));
        await record1.addFieldValue(ZOHOCRMSDK.Record.Field.Calls.CALL_START_TIME, new Date(2023,8,2,11,3,6));
        let user2 : ZOHOCRMSDK.Users.Users = new ZOHOCRMSDK.Users.Users();
        user2.setId(BigInt("4402800254001"));
        record1.addKeyValue("Call_Owner", user2);
        await record1.addFieldValue(ZOHOCRMSDK.Record.Field.Calls.SUBJECT, 'call Scheduled');
        // await record1.addFieldValue(ZOHOCRMSDK.Record.Field.Calls.REMINDER, new ZOHOCRMSDK.Choice("5 mins"));
        await record1.addFieldValue(ZOHOCRMSDK.Record.Field.Calls.CALL_PURPOSE, new ZOHOCRMSDK.Choice("Demo"));
        await record1.addFieldValue(ZOHOCRMSDK.Record.Field.Calls.CALL_AGENDA, 'agenda to make a call');
        record1.addKeyValue('$se_module', "Accounts");

        // log a call
        let whoId1 : ZOHOCRMSDK.Record.Record = new ZOHOCRMSDK.Record.Record();
        whoId1.setId(BigInt("440280030088"));
        await record1.addFieldValue(ZOHOCRMSDK.Record.Field.Calls.WHO_ID, whoId1);
        let whatId1 : ZOHOCRMSDK.Record.Record = new ZOHOCRMSDK.Record.Record();
        whatId1.setId(BigInt("4402801389082"));
        await record1.addFieldValue(ZOHOCRMSDK.Record.Field.Calls.WHAT_ID, whatId1);
        await record1.addFieldValue(ZOHOCRMSDK.Record.Field.Calls.CALL_TYPE, new ZOHOCRMSDK.Choice("Outbound"));
        await record1.addFieldValue(ZOHOCRMSDK.Record.Field.Calls.SUBJECT, "Call");
        await record1.addFieldValue(ZOHOCRMSDK.Record.Field.Calls.CALL_DURATION, "10:00");
        await record1.addFieldValue(ZOHOCRMSDK.Record.Field.Calls.OUTGOING_CALL_STATUS, new ZOHOCRMSDK.Choice("Completed"));
        await record1.addFieldValue(ZOHOCRMSDK.Record.Field.Calls.CALL_START_TIME, new Date(2023,2,12, 11, 3, 6));
        await record1.addFieldValue(ZOHOCRMSDK.Record.Field.Calls.CALL_PURPOSE, new ZOHOCRMSDK.Choice("Demo"));
        await record1.addFieldValue(ZOHOCRMSDK.Record.Field.Calls.CALL_AGENDA, "agenda to make call");
        await record1.addFieldValue(ZOHOCRMSDK.Record.Field.Calls.CALL_RESULT, "Not interested");
        await record1.addFieldValue(ZOHOCRMSDK.Record.Field.Calls.DESCRIPTION, 'description');
        record1.addKeyValue('$se_module', "Accounts");
        //
    ...
    static async initializeAndCall() {
        ...
        await (await new ZOHOCRMSDK.InitializeBuilder())
            ...
            .token(token)
            .initialize();
        await UpdateCalls.updateCalls("Calls");
    }
}
UpdateCalls.initializeAndCall();
