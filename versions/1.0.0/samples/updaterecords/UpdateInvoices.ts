...
{
    static async updateInvoices(moduleAPIName: string)
    {
        ...
        accountName.setId(BigInt("4402401390054"));
        ...
        contactName.setId(BigInt("4402801393062"));
    ...
    static async initializeAndCall() {
        ...
        await (await new ZOHOCRMSDK.InitializeBuilder())
            ...
            .token(token)
            .initialize();
        await UpdateInvoices.updateInvoices("Invoices");
    }
}
UpdateInvoices.initializeAndCall();
