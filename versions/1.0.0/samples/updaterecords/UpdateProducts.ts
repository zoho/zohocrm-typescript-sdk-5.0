...
{
    static async updateProducts(moduleAPIName: string)
    {
        ...
        vendorName.setId(BigInt("44028030038n"));
        await record1.addFieldValue(ZOHOCRMSDK.Record.Field.Products.VENDOR_NAME, vendorName);
        let handler : ZOHOCRMSDK.Users.Users = new ZOHOCRMSDK.Users.Users();
        handler.setId(BigInt("440280254001n"));
        ...
        let taxes : Array<ZOHOCRMSDK.Record.Tax> = new Array<ZOHOCRMSDK.Record.Tax>();
        let line_tax : ZOHOCRMSDK.Record.Tax = new ZOHOCRMSDK.Record.Tax();
        line_tax.setId(BigInt("440280020810n"));
    ...
    static async initializeAndCall() {
        ...
        await (await new ZOHOCRMSDK.InitializeBuilder())
            ...
            .token(token)
            .initialize();
        await UpdateProducts.updateProducts("Products");
    }
}
UpdateProducts.initializeAndCall();
