...
export class GetVariableGroupByAPIName
{
    public static async getVariableGroupByAPIName(variableGroupAPIName: string) {
        ...
        let response: ZOHOCRMSDK.APIResponse<ZOHOCRMSDK.GroupsVariable.ResponseHandler.MasterModel> = await variableGroupsOperations.getVariableGroupByAPIName(variableGroupAPIName);
        if (response != null) {
    ...
    static async initializeAndCall()
    {
        ...
        await (await new ZOHOCRMSDK.InitializeBuilder())
            ...
            .token(token)
            .initialize();
        await GetVariableGroupByAPIName.getVariableGroupByAPIName("General");
    }
}
