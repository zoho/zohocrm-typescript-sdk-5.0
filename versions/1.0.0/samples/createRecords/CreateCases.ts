...
class CreateCases
{
    static async createCases(moduleAPIName: string)
    {
        ...
        dealName.addKeyValue("id", BigInt('44028001393069'));
    ...
    static async initializeAndCall() {
        ...
        await (await new ZOHOCRMSDK.InitializeBuilder())
            ...
            .token(token)
            .initialize();
        await CreateCases.createCases("Cases");
    }
}
CreateCases.initializeAndCall();
