...
class CreateCalls
{
    static async createCalls(moduleAPIName: string)
    {
        ...
        await record1.addFieldValue(ZOHOCRMSDK.Record.Field.Calls.CALL_START_TIME, new Date(2023,10,2,11,3,6));
        let user2 : ZOHOCRMSDK.Users.Users = new ZOHOCRMSDK.Users.Users();
        user2.setId(BigInt("440280254001"));
        ...
        whoId1.setId(BigInt("44028001659005"));
        ...
        whatId1.setId(BigInt("44028001659002"));
        ...
        await record1.addKeyValue("Call_Result", new ZOHOCRMSDK.Choice("Not interested"));
    ...
    static async initializeAndCall()
    {
        ...
        await (await new ZOHOCRMSDK.InitializeBuilder())
            ...
            .token(token)
            .initialize();
        await CreateCalls.createCalls("Calls");
    }
}
CreateCalls.initializeAndCall();
