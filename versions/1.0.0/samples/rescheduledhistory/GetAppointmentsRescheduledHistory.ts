...
class GetAppointmentsRescheduledHistory
{
    static async getAppointmentsRescheduledHistory()
    {
        ...
        let response : ZOHOCRMSDK.APIResponse<ZOHOCRMSDK.HistoryReschedule.ResponseHandler.MasterModel> = await rescheduleHistoryOperations.getAppointmentsRescheduledHistory(parameterInstance);
        if (response != null) {
...
GetAppointmentsRescheduledHistory.initializeAndCall();
