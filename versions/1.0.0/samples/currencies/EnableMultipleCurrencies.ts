...
export class EnableMultipleCurrencies
{
    public static async enableMultipleCurrencies() {
        ...
        let response: ZOHOCRMSDK.APIResponse<ZOHOCRMSDK.Currencies.ActionHandler.MasterModel> = await currenciesOperations.enableCurrency(request);
        if (response !== null) {
...
EnableMultipleCurrencies.initializeAndCall()
