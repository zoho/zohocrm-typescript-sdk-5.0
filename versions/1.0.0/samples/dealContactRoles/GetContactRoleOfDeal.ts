...
class GetContactRoleOfDeal {
    static async getContactRoleOfDeal(contactId : bigint, dealId : bigint) {
        let contactRoleSOperations = new ZOHOCRMSDK.ContactDealRoles.DealContactRolesOperations();
        let response = await contactRoleSOperations.getAssociatedContactRolesSpecificToContact(contactId, dealId);
        if (response != null) {
            ...
            if (responseHandler instanceof ZOHOCRMSDK.ContactDealRoles.BodyWrapper) {
                ...
                records.forEach(record => {
                    ...
                    console.log(record.getCreatedTime().toString());
                    console.log("\n");
                ...
                let exception : ZOHOCRMSDK.ContactDealRoles.APIException = responseHandler;
...
GetContactRoleOfDeal.initializeAndCall();
