...
import {DeleteContactRoles} from "./DeleteContactRoles";
export class DeleteContactRole
{
    public static async deleteContactRole(contactRoleId: bigint) {
        ...
        let response: ZOHOCRMSDK.APIResponse<ZOHOCRMSDK.ContactRoles.ActionHandler.MasterModel> = await contactRolesOperations.deleteRole(contactRoleId);
        if (response !== null) {
    ...
    static async initializeAndCall(){
        ...
        await (await new ZOHOCRMSDK.InitializeBuilder())
            ...
            .token(token)
            .initialize();
        await DeleteContactRole.deleteContactRole(BigInt("44028001632005"));
    }
}
