...
export class UpdateRelatedRecordUsingExternalId
{
    public static async updateRelatedRecordUsingExternalId(moduleAPIName: string, externalValue: string, relatedListAPIName: string, externalFieldValue: string) {
        ...
        let xExternal = "external123.12345.External.54321";
         ...
         * 2 -> Value
         */
        // record1.addFieldValue(ZOHOCRMSDK.Record.Field.Notes.NOTE_CONTENT, "updated using external");
        record1.addKeyValue("Usage Unit", new ZOHOCRMSDK.Choice("Dozen"));
        ...
        let response: ZOHOCRMSDK.APIResponse<ZOHOCRMSDK.RecordsRelated.ActionHandler.MasterModel> = await relatedRecordsOperations.updateRelatedRecordUsingExternalId(externalFieldValue, externalValue, request);
        if (response != null) {
    ...
    static async initializeAndCall()
    {
        ...
        let externalValue : string = "12345";
        let relatedModuleAPIName: string = "Notes";
        let externalFieldValue : string= "external123";
        await UpdateRelatedRecordUsingExternalId.updateRelatedRecordUsingExternalId(moduleAPIName, externalValue, relatedModuleAPIName, externalFieldValue);
    }
}
