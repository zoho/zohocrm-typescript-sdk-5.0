...
class GetPortals
{
    static async getPortals()
    {
        ...
        let response : ZOHOCRMSDK.APIResponse<ZOHOCRMSDK.Portals.ResponseHandler.MasterModel>= await portalsOperations.getPortals();
        if (response != null)
        {
            ...
            if (responseHandler instanceof ZOHOCRMSDK.Portals.ResponseWrapper)
            {
                ...
                if (portals != null)
                {
                    portals.forEach(portal  => {
                        ...
                        let modifiedBy : ZOHOCRMSDK.Portals.Owner = portal.getModifiedBy();
                        if (modifiedBy != null) {
                            console.log("Portals Modified User-Id : " + modifiedBy.getId() + "\n");
                            console.log("Portals Modified User-Name : " + modifiedBy.getName() + "\n");
                        }
                        let createdBy : ZOHOCRMSDK.Portals.Owner= portal.getCreatedBy();
                        if (createdBy != null) {
