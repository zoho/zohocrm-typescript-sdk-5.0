...
{
    static async massDeleteRecordId(moduleAPIName: string)
    {
        ...
        let bodyWrapper : ZOHOCRMSDK.CvidDeleteMass.RecordIdBodyWrapper = new ZOHOCRMSDK.CvidDeleteMass.RecordIdBodyWrapper();
        bodyWrapper.setIds([BigInt("44028001629140")]);
        ...
        let response : ZOHOCRMSDK.APIResponse<ZOHOCRMSDK.CvidDeleteMass.ActionHandler.MasterModel>= await massDeleteCvidOperations.massDeleteByRecordId(bodyWrapper);
        if (response != null)
        {
    ...
    static async initializeAndCall()
    {
        ...
        await (await new ZOHOCRMSDK.InitializeBuilder())
            ...
            .token(token)
            .initialize();
        await MassDeleteRecordId.massDeleteRecordId("Calls");    }
}
MassDeleteRecordId.initializeAndCall();
