...
{
    static async getScoringRule(module: string, id: bigint)
    {
        ...
        let response : ZOHOCRMSDK.APIResponse<ZOHOCRMSDK.RulesScoring.ResponseHandler.MasterModel>= await scoringRulesOperations.getScoringRule(module, id,paramInstance);
        if(response!= null)
        {
    ...
    static async initializeAndCall()
    {
        ...
        await (await new ZOHOCRMSDK.InitializeBuilder())
            ...
            .token(token)
            .initialize();
        await GetScoringRule.getScoringRule("Leads", BigInt("334242341232"));
    }
}
GetScoringRule.initializeAndCall();
