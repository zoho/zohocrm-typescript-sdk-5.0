...
class UpdateScoringRules
{
    static async updateScoringRules()
    {
        ...
        signal.setId(BigInt("4876876112019"));
        ...
        let response : ZOHOCRMSDK.APIResponse<ZOHOCRMSDK.RulesScoring.ActionHandler.MasterModel> = await scoringRulesOperations.updateScoringRules(bodyWrapper);
        if (response != null)
        {
    ...
    static async initializeAndCall()
    {
        ...
        await (await new ZOHOCRMSDK.InitializeBuilder())
            ...
            .token(token)
            .initialize();
        await UpdateScoringRules.updateScoringRules();
    }
}
UpdateScoringRules.initializeAndCall();
