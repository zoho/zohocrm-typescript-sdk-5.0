...
export class UpdateRoles{
    static async updateRoles() {
        ...
        let response: ZOHOCRMSDK.APIResponse<ZOHOCRMSDK.Roles.ActionHandler.MasterModel> = await rolesOperations.updateRoles(bodyWrapper);
        if (response != null) {
