...
class GetModule
{
    static async getModule(recordId: bigint, module: string)
    {
        ...
        let response : ZOHOCRMSDK.APIResponse<ZOHOCRMSDK.EntityScores.ResponseHandler.MasterModel>= await entityScoresOperations.getModule(recordId, module);
        if(response != null)
        {
    ...
    static async initializeAndCall()
    {
        ...
        await GetModule.getModule(id, moduleAPIName);
    }
}
GetModule.initializeAndCall();