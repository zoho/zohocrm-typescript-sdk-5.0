...
import {Token} from "@zohocrm/typescript-sdk-5.0";
class GetRecord{
    /**
     * <h3> Get Record</h3>
     ...
     */
    static async getRecord(moduleAPIName: string, recordId: bigint, destinationFolder: string) {
        //example
        ...
        let fieldsArray : string[] = ["id", "Company", "Subform_2"];
    ...
    static async initializeAndCall()
    {
        ...
        let recordId: bigint = BigInt("44028001821046");
        let destinationFolder: string = "users/documents/file";
        await GetRecord.getRecord(moduleAPIName, recordId, destinationFolder);
    }
}
GetRecord.initializeAndCall();