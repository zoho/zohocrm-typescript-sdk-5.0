...
class GetUsersUnavailability {
    static async getUsersUnavailabilityHours()
    {
        ...
        await paramInstance.add(ZOHOCRMSDK.UnavailabilityUsers.GetUsersUnavailabilityParam.GROUP_IDS, "44028001307102,44028001326019");
        await paramInstance.add(ZOHOCRMSDK.UnavailabilityUsers.GetUsersUnavailabilityParam.INCLUDE_INNER_DETAILS, "56xxx8");
        await paramInstance.add(ZOHOCRMSDK.UnavailabilityUsers.GetUsersUnavailabilityParam.ROLE_IDS, "3433706109,34037061091");
        await paramInstance.add(ZOHOCRMSDK.UnavailabilityUsers.GetUsersUnavailabilityParam.TERRITORY_IDS, "44028001305227");
       let filters : {}= {};
        ...
        await paramInstance.add(ZOHOCRMSDK.UnavailabilityUsers.GetUsersUnavailabilityParam.FILTERS, JSON.stringify(filters,null,4));
        let response : ZOHOCRMSDK.APIResponse<ZOHOCRMSDK.UnavailabilityUsers.ResponseHandler.MasterModel>= await usersOperations.getUsersUnavailability(paramInstance);
        if (response != null)
        {
...
GetUsersUnavailability.initializeAndCall();
