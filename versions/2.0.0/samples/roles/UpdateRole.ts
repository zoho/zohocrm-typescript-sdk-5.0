...
export class UpdateRole{
    static async updateRole(id:bigint) {
        ...
        reportingTo.setId(BigInt("440280031151"));
        ...
        let response: ZOHOCRMSDK.APIResponse<ZOHOCRMSDK.Roles.ActionHandler.MasterModel> = await rolesOperations.updateRole(id, bodyWrapper);
        if (response != null) {
    ...
    static async initializeAndCall()
    {
        ...
        await (await new ZOHOCRMSDK.InitializeBuilder())
            ...
            .token(token)
            .initialize();
        await UpdateRole.updateRole(BigInt("44028001502018"));
    }
}
UpdateRole.initializeAndCall();
