...
{
    static async cloneScoringRule(id: bigint)
    {
        ...
        let response : ZOHOCRMSDK.APIResponse<ZOHOCRMSDK.RulesScoring.ActionHandler.MasterModel> = await scoringRulesOperations.cloneScoringRule(id);
        if (response != null)
        {
...
CloneScoringRule.initializeAndCall();
