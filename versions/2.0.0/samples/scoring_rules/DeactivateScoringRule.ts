...
class DeactivateScoringRule
{
    static async deactivateScoringRule(id:bigint)
    {
        ...
        let response : ZOHOCRMSDK.APIResponse<ZOHOCRMSDK.RulesScoring.ActionHandler.MasterModel>= await scoringRulesOperations.deactivateScoringRule(id);
        if (response != null)
        {
    ...
    static async initializeAndCall()
    {
        ...
        await (await new ZOHOCRMSDK.InitializeBuilder())
            ...
            .token(token)
            .initialize();
        await DeactivateScoringRule.deactivateScoringRule(BigInt("44028001626031"));
    }
}
DeactivateScoringRule.initializeAndCall();
