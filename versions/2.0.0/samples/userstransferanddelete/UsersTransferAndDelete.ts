...
class UsersTransferAndDelete
{
    static async usersTransferAndDelete()
    {
        ...
        transferAndDelete.setId(BigInt('44028001647189'));
        ...
        transfer.setId(BigInt("44028001502002"));
        ...
        moveSubordinate.setId(BigInt("44028001502002"));
        ...
        let response : ZOHOCRMSDK.APIResponse<ZOHOCRMSDK.DeleteTransferUsers.ActionHandler.MasterModel> = await usersTransferDeleteOperations.usersTransferAndDelete(request);
        if (response != null) {
...
UsersTransferAndDelete.initializeAndCall();
