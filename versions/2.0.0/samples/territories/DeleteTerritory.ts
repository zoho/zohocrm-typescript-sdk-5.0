...
{
    static async deleteTerritory(id: bigint)
    {
        ...
        let response : ZOHOCRMSDK.APIResponse<ZOHOCRMSDK.Territories.ActionHandler.MasterModel> = await territoriesOperations.deleteTerritory(id,paraminstance);
        if (response != null) {
    ...
    static async initializeAndCall() {
        ...
        await (await new ZOHOCRMSDK.InitializeBuilder())
            ...
            .token(token)
            .initialize();
        await DeleteTerritory.deleteTerritory(BigInt("44028001647136"));
    }
}
DeleteTerritory.initializeAndCall();
