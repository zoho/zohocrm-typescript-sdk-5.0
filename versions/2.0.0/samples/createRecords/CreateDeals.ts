...
class CreateDeals
{
    static async createDeals(moduleAPIName: string)
    {
        ...
        await record1.addFieldValue(ZOHOCRMSDK.Record.Field.Deals.PIPELINE, new ZOHOCRMSDK.Choice<string>("Standard (Standard)"))
        ...
        let campaign_source : ZOHOCRMSDK.Record.Record = new ZOHOCRMSDK.Record.Record();
        campaign_source.setId(BigInt("44028001540035"));
    ...
    static async initializeAndCall() {
        ...
        await (await new ZOHOCRMSDK.InitializeBuilder())
            ...
            .token(token)
            .initialize();
        await CreateDeals.createDeals("Deals");
    }
}
CreateDeals.initializeAndCall();
