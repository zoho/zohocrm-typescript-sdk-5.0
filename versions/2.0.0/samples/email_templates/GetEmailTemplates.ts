...
{
    public static async getEmailTemplates(moduleAPIName: string) {
        ...
        let response: ZOHOCRMSDK.APIResponse<ZOHOCRMSDK.EmailTemplates.ResponseHandler.MasterModel> = await emailTemplatesOperations.getEmailTemplates(paramInstance);
        if (response != null) {
            ...
            if (responseHandler instanceof ZOHOCRMSDK.EmailTemplates.ResponseWrapper) {
                ...
                let info: ZOHOCRMSDK.EmailTemplates.Info = responseWrapper.getInfo();
    ...
    static async initializeAndCall(){
        ...
        await (await new ZOHOCRMSDK.InitializeBuilder())
            ...
            .token(token)
            .initialize();
        await GetEmailTemplates.getEmailTemplates("Leads");
    }
}
GetEmailTemplates.initializeAndCall()
