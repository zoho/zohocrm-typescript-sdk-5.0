...
class UpdateCases
{
    static async updateCases(moduleAPIName: string)
    {
        ...
        productName.setId(BigInt("403334342442"));
        ...
        contactName.setId(BigInt("400234244232"));
        ...
        accountName.setId(BigInt("4330242352342342"));
        ...
        dealName.addKeyValue("id", BigInt("42334423425234"));
    ...
    static async initializeAndCall() {
        ...
        await (await new ZOHOCRMSDK.InitializeBuilder())
            ...
            .token(token)
            .initialize();
        await UpdateCases.updateCases("Cases");
    }
}
UpdateCases.initializeAndCall();
