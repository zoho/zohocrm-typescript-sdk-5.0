...
class UpdateTasks
{
    static async updateTasks(moduleAPIName: string)
    {
        ...
        whoId.setId(BigInt("44028001393062"));
        ...
        whatId.setId(BigInt("440280093052"));
    ...
    static async initializeAndCall() {
        ...
        await (await new ZOHOCRMSDK.InitializeBuilder())
            ...
            .token(token)
            .initialize();
        await UpdateTasks.updateTasks("Tasks");
    }
}
UpdateTasks.initializeAndCall();
