...
class UpdateSalesOrders
{
    static async updateSalesOrders(moduleAPIName: string)
    {
...
//		account.addKeyValue("name", "automated");
        await account.addFieldValue(ZOHOCRMSDK.Record.Field.Accounts.ID, BigInt("4402801393052"));
        ...
        await quoteName.addFieldValue(ZOHOCRMSDK.Record.Field.Quotes.ID, BigInt("440281392125"));
        ...
        await deal_name.addFieldValue(ZOHOCRMSDK.Record.Field.Deals.ID, BigInt("440280393069"));
        ...
        await contact_name.addFieldValue(ZOHOCRMSDK.Record.Field.Contacts.ID, BigInt("4402801393062"));
    ...
    static async initializeAndCall() {
        ...
        await (await new ZOHOCRMSDK.InitializeBuilder())
            ...
            .token(token)
            .initialize();
        await UpdateSalesOrders.updateSalesOrders("Sales_Orders");
    }
}
UpdateSalesOrders.initializeAndCall();
