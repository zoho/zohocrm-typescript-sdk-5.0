...
{
    static async updateContacts(moduleAPIName: string)
    {
        ...
        accountName.setId(BigInt("44028390054"));
        ...
        vendorName.setId(BigInt("440280330038"));
        ...
        reportingTo.setId(BigInt("430900423424"));
    ...
    static async initializeAndCall() {
        ...
        await (await new ZOHOCRMSDK.InitializeBuilder())
            ...
            .token(token)
            .initialize();
        await UpdateContacts.updateContacts("Contacts");
    }
}
UpdateContacts.initializeAndCall();
