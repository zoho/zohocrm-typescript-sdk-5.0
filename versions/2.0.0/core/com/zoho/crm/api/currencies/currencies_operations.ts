...
class CurrenciesOperations{
	 ...
	 * @throws SDKException
	 */
	public async createCurrencies(request: BodyWrapper): Promise<APIResponse<ActionHandler>>	{
		let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
		let apiPath: string = '';
		apiPath = apiPath.concat("/crm/v5/org/currencies");
		handlerInstance.setAPIPath(apiPath);
	 ...
	 * @param currency A BigInt representing the currency
	 * @returns An instance of APIResponse<ResponseHandler>
	 * @throws SDKException
	 */
	public async getCurrency(currency: bigint): Promise<APIResponse<ResponseHandler>>	{
		let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
		let apiPath: string = '';
		apiPath = apiPath.concat("/crm/v5/org/currencies/");
	 ...
	 * @throws SDKException
	 */
	public async updateCurrency(currency: bigint, request: BodyWrapper): Promise<APIResponse<ActionHandler>>	{
		let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
		let apiPath: string = '';
		apiPath = apiPath.concat("/crm/v5/org/currencies/");
		apiPath = apiPath.concat(currency.toString());
	 ...
	 * @throws SDKException
	 */
	public async enableCurrency(request: BaseCurrencyWrapper): Promise<APIResponse<ActionHandler>>	{
		let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
		let apiPath: string = '';
