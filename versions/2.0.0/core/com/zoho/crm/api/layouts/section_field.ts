...
import {SectionSubformField} from "./section_subform_field";
...
class SectionField extends Fields implements Model{
	...
	protected subform: SectionSubformField;
	 ...
	 * @returns An instance of SectionSubformField
	 */
	public getSubform(): SectionSubformField	{
		return this.subform;
	 ...
	 * @param subform An instance of SectionSubformField
	 */
	public setSubform(subform: SectionSubformField): void	{
