...
class ActionWrapper implements Model, ActionHandler{
	...
	private appointmentPreferences: ActionResponse;
	private keyModified: Map<string, number> = new Map<string, number>();
	/**
	 * The method to get the appointmentPreferences
	 * @returns An instance of ActionResponse
	 */
	public getAppointmentPreferences(): ActionResponse	{
	 ...
	 */
	public setAppointmentPreferences(appointmentPreferences: ActionResponse): void	{
