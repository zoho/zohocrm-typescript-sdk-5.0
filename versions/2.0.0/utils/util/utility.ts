...
class Utility {
    ...
    static async fileExistsFlow( moduleAPIName : string | null, recordFieldDetailsPath : string, lastModifiedTime: number|null) {
        ...
        } else if (initializer.getSDKConfig() != null && initializer.getSDKConfig().getAutoRefreshFields() == false && this.forceRefresh &&
    ...
    static async verifyModuleAPIName(moduleName : string) {
        ...
        var recordFieldDetailsPath: string = await this.getFileName();
        ...
        try {
            ...
            if (moduleAPIName != null) {
                ...
                if (
                    ...
                    ( moduleAPIName != null && !Constants.SKIP_MODULES.includes(moduleAPIName.toLowerCase()))) {
                    return;
                }
            }

            recordFieldDetailsPath = resourcesPath + "/" + await this.getFileName().catch((err) => {
                throw err;
            });
    ...
    static async modifyFields(recordFieldDetailsPath : string , modifiedTime: number | null) {
        ...
        let recordFieldDetailsJson : { [key: string]: any } = await Initializer.getJSON(
            recordFieldDetailsPath
        );
    ...
    static async getRelatedLists(
        ...
        try {
            ...
            var recordFieldDetailsPath = initializer.getResourcePath() + "resources/" +  await this.getFileName().catch((err) => {
                throw err;
            });
    ...
    static async getRelatedListDetails(moduleAPIName : string) {
        ...
        let GetRelatedListsParam = (
            await import("../../core/com/zoho/crm/api/related_lists/related_lists_operations.js")
        ...
        let response = await new RelatedListsOperations().getRelatedLists(paramInstance);
                    ...
                    relatedLists.forEach((relatedList) => {
                        ...
                        relatedListDetail[Constants.MODULE] =
                            relatedList.getModule() != null
                                ? relatedList.getModule().getAPIName()
                                : Constants.NULL_VALUE;
    ...
    static async getFieldsDetails(moduleAPIName : string) : Promise<any>{
        ...
        let FieldsResponseWrapper = (await import("../../core/com/zoho/crm/api/fields/body_wrapper.js")).BodyWrapper;
        ...
        let response = await new FieldOperations().getFields(paramInstance);
    ...
    static async getModules(header : number | null) : Promise<any>{
        ...
        if (header == null) {
            try {
                ...
                var recordFieldDetailsPath = resourcesPath + "/" + await this.getFileName().catch((err) => {
                    throw err;
                });
    ...
    static async setDataType(fieldDetail: { [key: string]: any } , field : Fields, moduleAPIName : string) {
        var apiType = field.getDataType().getValue();
        ...
        if (
            ...
            if (field.getFormula() != null) {
                let returnType = field.getFormula().getReturnType().getValue();
        ...
        if (apiType == Constants.LOOKUP && field.getLookup() != null) {
            ...
            if (module1 != null && module1.getAPIName().toLowerCase() != Constants.SE_MODULE) {
                ...
                if (
                    module1.getAPIName().toLowerCase() == Constants.ACCOUNTS &&
                    field.getCustomField() != null &&
        ...
        if (module != null && module.getAPIName() != null && module.getAPIName().length > 0) {
            await Utility.getFieldsInfo(module.getAPIName()).catch((err) => {
                throw err;
            });
        }
