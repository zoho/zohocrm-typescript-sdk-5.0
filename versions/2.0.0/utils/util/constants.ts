export class Constants {
    ...
    public static SET_TO_CONTENT_TYPE = ["/crm/bulk/v2.1/read", "/crm/bulk/v2.1/write"];
    ...
    public static SDK_NAME = "typescript-2.1";
    ...
    static MULTI_MODULE_LOOKUP = "multi_module_lookup";

    static IMAGE_UPLOAD_NAMESPACE = "core/com/zoho/crm/api/record/image_upload";
